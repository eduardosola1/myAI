...
export const CHAT_HEADER: string = `Charlie - Your AI-Powered Guide to Investing & Market Trends`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized AI by Eduardo Sola`;
export const CLEAR_BUTTON_TEXT: string = `Clear Chat`;
export const PAGE_TITLE: string = `Charlie - AI Assistant`;
